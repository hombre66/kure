...
from tkinter import Frame, Canvas, Menu, BOTH, YES, Label, StringVar, BOTTOM, Tk, mainloop, Entry
...
class Parametrs_Dialog(Dialog):
    ...
    def __init__(self,parent,parameters, title = 'Enter detail'):
...
class App(Frame):
    ...
    def Start(self):
        ...
        self.d= Parametrs_Dialog(self,{'Measure':20e-6},title='Enter Units in [m]')
